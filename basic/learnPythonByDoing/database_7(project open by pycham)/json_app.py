...
def menu():
    json_database.create_book_table()
...
def prompt_add_book():
    ...
    json_database.add_book(name, author)


def list_books():
    books = json_database.get_all_books()
    for book in books:
...
def prompt_read_book():
    ...
    json_database.mark_book_as_read(name)
...
def prompt_delete_book():
    ...
    json_database.delete_book(name)
