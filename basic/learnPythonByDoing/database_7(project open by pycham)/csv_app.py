...
def menu():
    csv_database.create_book_table()
...
def prompt_add_book():
    ...
    csv_database.add_book(name, author)


def list_books():
    books = csv_database.get_all_books()
    for book in books:
...
def prompt_read_book():
    ...
    csv_database.mark_book_as_read(name)
